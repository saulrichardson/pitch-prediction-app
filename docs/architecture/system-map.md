...
| Persistence | `packages/db/src/` | Store games, timelines, branches, prediction runs, manual situations, and audit events through explicit memory, DynamoDB, or PostgreSQL storage modes |
